...
//#endif
        ...
        private static object ParseDefaultValue(Type type, object value)
        {
            ...
            if (value is string)
            {
                ...
                switch (Helpers.GetTypeCode(type))
                {
                    ...
                    //case ProtoTypeCode.SmartInt: return (SmartInt)int.Parse(s, NumberStyles.Any, CultureInfo.InvariantCulture);
            ...
            //if (type == typeof(SmartInt)) return new SmartInt((int)value);
            ...
            bool asReference, bool dynamicType, bool overwriteList, bool allowComplexTypes)
        {
            ...
            switch (code)
            {
                ...
                //case ProtoTypeCode.SmartInt:
                //    defaultWireType = GetIntWireType(dataFormat, 32);
                //    return new SmartIntSerializer(model);
